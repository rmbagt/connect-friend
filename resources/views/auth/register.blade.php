            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input id="instagram_username" type="text" class="form-control @error('instagram_username') is-invalid @enderror" name="instagram_username" value="{{ old('instagram_username') }}" required>
                                </div>
                        ...
                        <div class="row mb-3">
                            <label for="hobbies" class="col-md-4 col-form-label text-md-end">{{ __('Hobbies (Select at least 3)') }}</label>
                            <div class="col-md-6">
                                @foreach($hobbies as $hobby)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="hobbies[]" value="{{ $hobby->id }}" id="hobby_{{ $hobby->id }}" {{ (is_array(old('hobbies')) && in_array($hobby->id, old('hobbies'))) ? 'checked' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="bio" class="form-control @error('bio') is-invalid @enderror" name="bio" rows="3" required>{{ old('bio') }}</textarea>
                                @error('bio')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
